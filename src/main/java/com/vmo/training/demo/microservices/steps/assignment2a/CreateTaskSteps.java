...
//    public CreateTaskSteps verifyRedirectToHomePage() {
//        action.waitElementIsPresent(img_Profile, 10);
//        Assert.assertTrue(action.verifyElementDisplay(img_Profile));
//    }
...
//    }
    ...
    @Step("Create a task")
    public Response createTask(Map<String,Object> map,String path) {
        return sendPostMethod(map, accessToken, path);
    }

    @Step("Reopen task")
    public Response reopenTask(Object object,String path) {
        return sendPostMethod(object, accessToken, path);
    }
    ...
    public String createProject(Object object,String path) {
        Response response = sendPostMethod(object, accessToken, path);
