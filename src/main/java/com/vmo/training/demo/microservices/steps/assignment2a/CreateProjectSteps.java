...
public class CreateProjectSteps extends BaseSteps {
    ...
    public CreateProjectSteps deleteProjectWhenMaximumProjects(Map<String, Object> map) {
    ...
    public CreateProjectSteps validateNumberProject(Map<String, Object> map, String path) {
